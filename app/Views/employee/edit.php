        ...
        <div class="form-grid">
            ...
            <div class="form-group col-span-6">
                ...
                <input type="text" name="front_title" class="form-control"
                    value="<?= old('front_title', $employee['front_title']) ?>" placeholder="Cth: Dr., Ir.">
            </div>

            <div class="form-group col-span-6">
                <label class="form-label">Gelar Belakang</label>
                <input type="text" name="back_title" class="form-control"
                    value="<?= old('back_title', $employee['back_title']) ?>" placeholder="Cth: S.Kom, M.M.">
            </div>
            ...
            <div class="col-span-12 form-group">
                ...
                <div
                    style="display: flex; align-items: flex-start; gap: 1.5rem; background: #f9fafb; padding: 1rem; border-radius: 8px; border: 1px dashed #d1d5db;">
                    <?php if (!empty($employee['photo'])): ?>
                        <div style="flex-shrink: 0; text-align: center;">
                            <img src="<?= base_url('uploads/photos/' . $employee['photo']) ?>" alt="Foto Profil"
                                style="width: 100px; height: 100px; object-fit: cover; border-radius: 50%; border: 3px solid white; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1);">
                            <div style="margin-top: 0.5rem; font-size: 0.75rem; color: #6b7280;">Foto Saat Ini</div>
                        </div>
                    <?php else: ?>
                        <div
                            style="width: 100px; height: 100px; background: #e5e7eb; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: #9ca3af; font-size: 2rem;">
            ...
            <div class="form-group col-span-6">
                ...
                <select name="role" class="form-control" required>
                    <option value="pegawai" <?= old('role', $employee['role']) == 'pegawai' ? 'selected' : '' ?>>Pegawai
                        Biasa</option>
                    <option value="admin" <?= old('role', $employee['role']) == 'admin' ? 'selected' : '' ?>>Administrator
                    </option>
                </select>
            ...
            <div class="form-group col-span-4">
                ...
                <input type="number" name="leave_balance_n" class="form-control"
                    value="<?= old('leave_balance_n', $employee['leave_balance_n']) ?>" min="0" max="12">
            ...
            <div class="form-group col-span-4">
                ...
                <input type="number" name="leave_balance_n1" class="form-control"
                    value="<?= old('leave_balance_n1', $employee['leave_balance_n1']) ?>" min="0" max="6">
            ...
            <div class="form-group col-span-4">
                ...
                <input type="number" name="leave_balance_n2" class="form-control"
                    value="<?= old('leave_balance_n2', $employee['leave_balance_n2']) ?>" min="0" max="6">
                <div class="form-hint">Maksimal 6 hari (Aturan ASN).</div>
            </div>
            ...
            <div class="form-group col-span-6">
                ...
                <input type="number" name="mkg_additional_years" class="form-control"
                    value="<?= old('mkg_additional_years', $employee['mkg_additional_years']) ?>" min="0">
            ...
            <div class="form-group col-span-6">
                ...
                <input type="number" name="mkg_additional_months" class="form-control"
                    value="<?= old('mkg_additional_months', $employee['mkg_additional_months']) ?>" min="0" max="11">
            </div>
            ...
            <div class="form-group col-span-6">
                ...
                <input type="number" name="mkg_adjustment_years" class="form-control"
                    value="<?= old('mkg_adjustment_years', $employee['mkg_adjustment_years']) ?>">
            ...
            <div class="form-group col-span-6">
                ...
                <input type="number" name="mkg_adjustment_months" class="form-control"
                    value="<?= old('mkg_adjustment_months', $employee['mkg_adjustment_months']) ?>">
            </div>
